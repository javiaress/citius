from models.ssm_ind_prueba2 import Modelo_ind as Modelo
from data.preprocess_prueba2 import load_and_preprocess_data
...
if __name__ == "__main__":
    ...
    model_name = "ssm_prueba2"
    
    folds_data = load_and_preprocess_data("./data", case_col="caseid", activity_col="task", time_col = "end_timestamp", dataset_name= dataset_name)
